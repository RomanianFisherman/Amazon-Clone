...
export function renderOrderSummary() {
    ...
    function updateCartQuantity() {
        ...
        const container = document.querySelector('.js-return-to-home-link');
        if (container) { container.innerHTML = `${cartQuantity} ${cartQuantity === 1 ? 'item' : 'items'}`};       
